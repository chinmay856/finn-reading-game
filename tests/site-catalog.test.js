...
test("only WikiWhy is speech-playable while six sites expose honest structural runtimes", () => {
  ...
  assert.deepEqual(runtimeAvailable.map(({ id }) => id), ["wikiwhy", "threadit", "faceplace", "mycorner", "yahuh", "mapguess"]);
