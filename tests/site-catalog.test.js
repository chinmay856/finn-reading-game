...
test("only WikiWhy is speech-playable while ThreadIt and FacePlace expose honest structural runtimes", () => {
  ...
  assert.deepEqual(runtimeAvailable.map(({ id }) => id), ["wikiwhy", "threadit", "faceplace"]);
