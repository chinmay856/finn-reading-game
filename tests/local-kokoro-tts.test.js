...
test("vocabulary read-aloud uses pinned local Kokoro Heart for the word, definition, and exact card sentence", () => {
  ...
  assert.match(source, /Definition: \$\{cleanDefinition\}\. Used in a sentence: \$\{cleanSentence\}/u);
