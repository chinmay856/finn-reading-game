...
export const YAHUH_COPY = Object.freeze({
  ...
  [YAHUH_COPY_IDS.completionAmy]: "You separated all six modules, reconnected their independent channels, and made sources and sponsorship visible. Yahuh is fixed. Site complete.",
  ...
  [YAHUH_COPY_IDS.midpointAmy]: "First half complete: all six modules are sorted and labeled again. Second half: reconnect each pair to independent channels so one generated stream cannot fill the whole page.",
