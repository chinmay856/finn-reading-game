...
export const YAHUH_COPY = Object.freeze({
  ...
  [YAHUH_COPY_IDS.midpointAmy]: "All six modules changed in the same millisecond. That is not a newsroom. That is one hose.",
  [YAHUH_COPY_IDS.midpointBody]: "PORTAL AUTO-FIX AI replaced all channels with one generated stream.\n\nEfficiency improved.\nMeaning did not.",
  [YAHUH_COPY_IDS.midpointChinmay]: "Separate categories were legacy clutter. I am now open to the possibility that clutter was doing useful work.",
