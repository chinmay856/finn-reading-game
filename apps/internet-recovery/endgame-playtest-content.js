...
export const ENDGAME_SITE_FIXTURES = Object.freeze(ENDGAME_SITE_ORDER.map((id, index) => {
  ...
  return Object.freeze({
    ...
    autoFrame: `/walkthroughs/endgame/site-crops/${id}-auto-site-v1.png?v=${id === "wikiwhy" ? "20260920-wikiwhy-repairs-v8" : ["viewtube", "spotty-fi", "amaze-on", "faceplace", "threadit", "searchish", "yahuh", "mycorner"].includes(id) ? "20260920-site-copy-v3" : "20260825-endgame-v2"}`,
    recoveredFrame: `/walkthroughs/endgame/site-crops/${id}-recovered-site-v1.png?v=${id === "wikiwhy" ? "20260920-wikiwhy-repairs-v8" : ["viewtube", "spotty-fi", "amaze-on", "faceplace", "threadit", "searchish", "yahuh", "mycorner"].includes(id) ? "20260920-site-copy-v3" : "20260825-endgame-v2"}`,
