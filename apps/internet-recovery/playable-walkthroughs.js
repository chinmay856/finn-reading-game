...
export const PLAYABLE_WALKTHROUGHS = Object.freeze({
  ...
  mycorner: Object.freeze({
    ...
    completionChinmay: completionChinmay("I CONFUSED CONSISTENCY WITH PROOF", "I asked Otto to fill in confusing profiles, and he made invented details look trustworthy. I should have required identity checks before polishing anything."),
  ...
  yahuh: Object.freeze({
    ...
    completionChinmay: completionChinmay("I TURNED HEADLINES INTO THE WHOLE NEWS", "I wanted faster reading, but I told Otto to put everything in the headline. I should have asked for useful summaries that still lead to the reporting and sources."),
  ...
  "amaze-on": Object.freeze({
    ...
    completionChinmay: completionChinmay("I LET “TEDIOUS” INCLUDE THE FINAL CHOICE", "I wanted Otto to help with comparison, but I didn't say the purchase still belonged to the shopper. I should have made confirmation non-negotiable."),
  ...
  searchish: Object.freeze({
    ...
    completionChinmay: completionChinmay("I ASKED FOR FAST AND LOST THE SEARCH", "I wanted the useful result easier to find, but Otto turned that into one answer. I should have required optional AI, labeled paid results, and the editable search."),
  ...
  "spotty-fi": Object.freeze({
    ...
    completionChinmay: completionChinmay("I MADE DISCOVERY SOUND LIKE CONTROL", "I wanted people to find something good, but I didn't say that the artist and listener still matter. I should have asked Otto to suggest—not generate, choose, or set the volume."),
