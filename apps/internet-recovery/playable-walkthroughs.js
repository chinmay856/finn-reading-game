...
function frame(directory, prefix, page) {
  if (directory === "spotty-fi") return `/walkthroughs/${directory}/${prefix}_p${page}.png?v=20260921-spotty-art-v5`;
...
export const PLAYABLE_WALKTHROUGHS = Object.freeze({
  ...
  "amaze-on": Object.freeze({
    ...
    completionChinmay: completionChinmay("I LET “TEDIOUS” INCLUDE THE FINAL CHOICE", "I wanted AUTO to help with comparison, but I didn't say the purchase still belonged to the shopper. I should have told AUTO to ask before buying."),
