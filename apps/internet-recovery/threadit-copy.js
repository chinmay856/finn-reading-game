...
export const THREADIT_COPY_IDS = Object.freeze({
  ...
  completionAmy: "site.threadit.completion.amy",
  completionChinmay: "site.threadit.completion.chinmay",
  completionTitle: "site.threadit.completion.title",
...
export const THREADIT_COPY = Object.freeze({
  ...
  [THREADIT_COPY_IDS.completionAmy]: "Finn restored the original question, separated the independent sources, and locked the ten copied accounts behind one duplicate-source warning. ThreadIt is fixed.",
  [THREADIT_COPY_IDS.completionChinmay]: "So the AI did not discover a ten-person consensus. It discovered copy and paste with excellent branding. I have disabled its victory post.",
  [THREADIT_COPY_IDS.completionTitle]: "THREADIT RECOVERY COMPLETE",
  ...
  [THREADIT_COPY_IDS.midpointAmy]: "First you restored the question, reply order, citations, and duplicate label. Now trace the ten loud accounts back to their real origins so copied agreement cannot pretend to be ten sources.",
  [THREADIT_COPY_IDS.midpointBody]: "The first four repairs made the conversation readable again. The final three traces test which branches are independent, separate the real sources, and quarantine the generated copies.",
  [THREADIT_COPY_IDS.midpointChinmay]: "Technically, the AI found agreement extremely efficiently. Unfortunately, it created the agreement first. Finn, please trace the hats before it starts counting scarves.",
