...
export const VIEWTUBE_COPY = freezeDeep({
  ...
  [VIEWTUBE_COPY_IDS.completionAmy]: "You restored the video's context, separated the footage, transcript, and source tracks, and stopped duplicate loops from pretending to be new evidence. ViewTube is fixed. Site complete.",
  ...
  [VIEWTUBE_COPY_IDS.midpointAmy]: "First half complete: the creator, frames, transcript, and source context are restored. The file hashes match, so every replay is the same clip. Second half: verify three separate evidence tracks and quarantine the repeated clip.",
