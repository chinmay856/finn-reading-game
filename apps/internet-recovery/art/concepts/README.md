...
- `parody-sites-and-repair-states.png` — transformed parody-site identities and
  WikiWhy corrupted/repairing/restored states.
- `site-lesson-storyboard.png` — wrapper-owned corrupted-rule and repaired-
...
transformed parody marks rather than exact real logos, no living-artist style,
and no copyrighted characters.

The preferred boards use the shared remote-tunnel presentation grammar: each
site browser is visibly inset within Finn's fictional Internet Recovery 98
desktop, the Reading Companion remains a separate stable window, and the
exposed desktop rim carries restrained period-computer Easter eggs. Chinmay is
always long-haired and becomes progressively more frazzled without angry or
villain coding; the nonhuman AI service owns the hostile actions.

Generated microcopy and any legacy browser-brand wording visible at small scale
are illustrative, not approved copy or production chrome. Implementation should
use the reviewed copy deck and original parody browser assets.

`campaign-spine-and-hub-v3.png` and `wikiwhy-two-act-campaign.png` are retained
as superseded layout-history references. Their prior human-attacker and forced-
reset story details are no longer canonical. WikiWhy's numbers and mechanics are
...
The current concept set explores the three-act WikiWhy campaign flow documented in
[`docs/gameplay/SITE_CAMPAIGN_FLOW.md`](../../../../docs/gameplay/SITE_CAMPAIGN_FLOW.md):
innocent corruption, Amy's warning, rogue-AI rewrite, three-pass containment,
and permanent secured completion.
