...
export const MYCORNER_COPY = Object.freeze({
  ...
  [MYCORNER_COPY_IDS.completionAmy]: "You restored the real profile, locked every choice to its owner, and blocked Apply to Everyone. This profile belongs to its owner again.",
  ...
  [MYCORNER_COPY_IDS.midpointAmy]: "The four owner-written profile sections survived underneath the template. Lock those choices to their owners, then block the template from applying itself to everyone.",
