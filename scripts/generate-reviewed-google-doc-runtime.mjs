...
const records = {};
const sources = {};
for (const site of ['faceplace', 'threadit', 'mycorner', 'yahuh', 'searchish', 'amaze-on']) {
...
console.log('Generated 56 approved passages with exact vocabulary and quick-check wording and correct-answer identities.');
