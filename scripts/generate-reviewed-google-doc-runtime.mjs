...
const records = {};
const sources = {};
for (const site of ['faceplace', 'threadit', 'mycorner', 'yahuh', 'searchish', 'amaze-on', 'viewtube', 'spotty-fi']) {
...
console.log('Generated 74 approved passages with exact vocabulary and quick-check wording and correct-answer identities.');
