...
const records = {};
const sources = {};
for (const site of ['faceplace', 'threadit', 'mycorner']) {
...
console.log('Generated 26 approved passages with exact vocabulary and quick-check wording and correct-answer identities.');
