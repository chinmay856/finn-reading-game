...
const records = {};
const sources = {};
for (const site of ['faceplace', 'threadit', 'mycorner', 'yahuh']) {
...
console.log('Generated 35 approved passages with exact vocabulary and quick-check wording and correct-answer identities.');
