...
The restored personal details use short, ordinary profile copy: Amy is an
engineer and coffee drinker who throws the ball for Techno; her latest bulletin
says Techno found the longest stick and is keeping it; her recent history also
includes a long run around San Francisco.
...
- `CHECK ACCOUNT HISTORY` restores Profile Blurbs, Latest Bulletins, and Known
  Friends together, using two large vertically stacked portraits—composed
  Chinmay and Techno—rather than small repeated tiles or a flustered dialogue
  pose.
