...
| Case File | Ten evidence slots plus the later `EVIDENCE_11.LIVE` slot. |
...
| --- | --- | --- | --- | --- | --- |
| 1 | WikiWhy | `The encyclopedia forgot what evidence is.` | `SOURCES OPTIONAL` | `EVIDENCE CONNECTED` | `AI WRITE ROUTE / 01` |
