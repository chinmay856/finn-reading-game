...
WikiWhy may use a simple left-to-right repair wipe for the first playable
prototype. Other sites should use site-specific progress fiction: a source tree,
feed tracker, scrapbook, category switchboard, evidence timeline, result
branches, receipt tape, mixtape queue, or route map may communicate progress
better than a generic wipe.
