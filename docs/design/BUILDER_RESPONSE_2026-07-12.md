...
This response was prepared against implementation commit `5542682` on
...
For the one added runtime crop, export `amy_tools` from row 2, column 3 of
`amy-production-portraits.png` as `amy-tools.jpg`, 384 by 384 pixels, matching
the current dialogue-crop framing and JPEG quality. This is a mechanical crop
of approved art, not a new portrait request.
